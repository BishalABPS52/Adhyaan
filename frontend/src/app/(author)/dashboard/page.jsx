    ...
    <div className={`${styles.container} ${isDark ? styles.dark : styles.light}`}>
      ...
      <div className={styles.pageHeader}>
        <div className={styles.headerRow}>
          <p className={styles.pageSubtitle}>Manage your content and track performance</p>
          <button
      ...
      <div className={styles.statsGrid}>
        ...
        <div className={styles.statCard}>
          ...
          <div className={styles.statContent}>
            <div className={styles.statValue}>{stats?.total_reviews || 0}</div>
            <div className={styles.statLabel}>Reviews</div>
            <div className={styles.statSublabel}>Total Reviews</div>
          </div>
        </div>
      </div>
        ...
        <div className={styles.uploadGrid}>
          ...
          >
            ...
            <div>
              ...
              <p className={styles.uploadCardDesc}>Upload indie books, academic books, or research papers</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className={styles.section}>
        ...
        {(!books || books.length === 0) ? (
          <div className={styles.emptyState}>
            ...
            <p className={styles.emptyStateText}>You haven't uploaded any books yet.</p>
            <button
              className={styles.uploadBtn}
              onClick={() => setShowUploadForm(true)}
            >
              ...
              <div key={book.id} className={styles.bookCard}>
                ...
                <div className={styles.bookInfo}>
                  ...
                  <div className={styles.bookMeta}>
                    <span>⭐ {book.rating ? book.rating.toFixed(1) : '0.0'}</span>
                  ...
                  <div className={styles.bookActions}>
                    <button
                      ...
                      onClick={() => router.push(`/author/edit-book/${book.id}`)}
                    >
                      Edit
                    </button>
                    <button
      ...
      <div className={styles.section}>
        ...
        <div className={styles.quickActionsGrid}>
          <div className={styles.actionCard} onClick={() => setShowUploadForm(true)}>
