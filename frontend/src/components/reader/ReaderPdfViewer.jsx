    ...
    <div className={styles.readerWrapper} ref={viewerRef}>
      <div className={styles.readerToolbar}>
        ...
        <div className={styles.controls}>
          <button className={styles.controlBtn} onClick={toggleOrientation} title="Toggle View Mode">
          ...
          <button className={styles.controlBtn} onClick={handleDownload} title="Download Book">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <button className={styles.controlBtn} onClick={toggleFullScreen} title="Fullscreen Focus Mode">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div className={`${styles.readerFrame} ${isLandscape ? styles.landscape : ''}`}>
        {loading && (
